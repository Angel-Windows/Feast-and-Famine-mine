local occultthings = {"pigskin_leather"}
...
GLOBAL.AllRecipes["armordragonfly"].ingredients = {Ingredient("dragon_scales", 1), Ingredient("armorwood", 1),
                                                   Ingredient("pigskin_leather", 3)}

if TUNING.OTHERLEATHER then
    GLOBAL.AllRecipes["saddle_basic"].ingredients = {Ingredient("beefalowool", 4), Ingredient("pigskin_leather", 4),
    ...
    GLOBAL.AllRecipes["umbrella"].ingredients = {Ingredient("twigs", 6), Ingredient("pigskin_leather", 1),
                                                 Ingredient("silk", 2)}
    GLOBAL.AllRecipes["reflectivevest"].ingredients = {Ingredient("rope", 1), Ingredient("feather_robin", 3),
                                                       Ingredient("pigskin_leather", 2)}
    GLOBAL.AllRecipes["piggyback"].ingredients = {Ingredient("pigskin_leather", 4), Ingredient("silk", 6),
                                                  Ingredient("rope", 2)}
    GLOBAL.AllRecipes["onemanband"].ingredients = {Ingredient("goldnugget", 2), Ingredient("nightmarefuel", 4),
                                                   Ingredient("pigskin_leather", 2)}
    GLOBAL.AllRecipes["antlionhat"].ingredients = {Ingredient("beefalowool", 5), Ingredient("pigskin_leather", 3),
                                                   Ingredient("townportaltalisman", 1)}
    if TIDDLES then
        GLOBAL.AllRecipes["hat_tiddlevirus"].ingredients = {Ingredient("petals", 6), Ingredient("pigskin_leather", 1),
