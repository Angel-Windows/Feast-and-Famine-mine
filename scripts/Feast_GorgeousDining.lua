...
InsertIngredientValues({"humanmeat"},{meat=1},true,true,true)
InsertIngredientValues({"moon_cap"},{mushrooms=1},true,false,true)
InsertIngredientValues({"red_cap"},{mushrooms=1,mushrooms_red=1},true,false,true)
InsertIngredientValues({"green_cap"},{mushrooms=1,mushrooms_green=1},true,false,true)
InsertIngredientValues({"blue_cap"},{mushrooms=1,mushrooms_blue=1},true,false,true)
InsertIngredientValues({"red_chunk", "red_chunk_bloom"},{mushrooms=1,mushrooms_red=1,veggie=0.5},false,false,true)
InsertIngredientValues({"green_chunk", "green_chunk_bloom"},{mushrooms=1,mushrooms_green=1,veggie=0.5},false,false,true)
InsertIngredientValues({"blue_chunk", "blue_chunk_bloom"},{mushrooms=1,mushrooms_blue=1,veggie=0.5},false,false,true)
InsertIngredientValues({"trunk_summer", "trunk_winter", "trunk_cooked", "trunk_winter_cooked"},{meat=1},false,false,true)
InsertIngredientValues({"honey"},{honey=1},false,false,true)
InsertIngredientValues({"honey_floral"},{sweetener=1,honey=1},false,false,false)
InsertIngredientValues({"honey_killer"},{sweetener=1,honey=1},false,false,false)
InsertIngredientValues({"honey_crystals"},{inedible=1,sugar=1},false,false,false)
InsertIngredientValues({"corn"},{sugar=1},false,false,true)
--InsertIngredientValues({"sap"},{syrup=1},false,false,true) -- TODO: Sugarwood forest compatability 
InsertIngredientValues({"syrup"}, {sweetener=1},false,false,false)
InsertIngredientValues({"egg_monster"},{egg=1,monster=1},true,false,false)
InsertIngredientValues({"egg_plant"},{egg=1,plantmeat=1},true,false,false)
InsertIngredientValues({"plantmeat"},{plantmeat=1},true,false,true)
InsertIngredientValues({"rocky_meat"},{shellfish=1,fish=2},false,false,true)
InsertIngredientValues({"wobster_sheller_land"},{shellfish=1},false,false,true)
if ISLAND or TROPICAL then InsertIngredientValues({"lobster"},{shellfish=1},false,false,true) end
InsertIngredientValues({"glommerfuel"},{},false,false,true)
InsertIngredientValues({"wheat"},{inedible=2},false,false,false)
InsertIngredientValues({"seeds"},{inedible=2},true,false,true)
InsertIngredientValues({"potato_seeds", "tomato_seeds", "carrot_seeds", "corn_seeds", "pumpkin_seeds", "watermelon_seeds", "asparagus_seeds", "eggplant_seeds", "onion_seeds", "garlic_seeds", "pepper_seeds", "dragonfruit_seeds"},{inedible=2},false,false,false)
InsertIngredientValues({"pomegranate_seeds"},{fruit=0.25},false,false,false)
InsertIngredientValues({"durian_seeds"},{monster=1},false,false,false)
if ISLAND then InsertIngredientValues({"sweet_potato_seeds"},{inedible=2},false,false,false) end
if LEGION then InsertIngredientValues({"pineananas_seeds"},{inedible=2},false,false,false) end
InsertIngredientValues({"flour"},{veggie=0.5,inedible=1,flour=1},false,false,false)
InsertIngredientValues({"pasta_dry"},{noodle=1},false,false,false)
InsertIngredientValues({"turnip"},{veggie=1},false,false,false)
InsertIngredientValues({"carrot"},{carrot=1},true,false,true)
InsertIngredientValues({"rock_avocado_fruit_ripe"},{stone=1},true,false,true)
InsertIngredientValues({"tomato_rock_dried"},{veggie=1},false,false,false)
InsertIngredientValues({"fishbite_dried"},{fish=0.5},false,false,false)
InsertIngredientValues({"fish_dried"},{fish=1},false,false,false)
InsertIngredientValues({"cheese_goat"},{cheese=1},false,false,false)
InsertIngredientValues({"berries", "berries_juicy"},{berries=0.5},true,false,true)
InsertIngredientValues({"bigbird_meat"},{meat=1,poultry=1},true,false,false)
InsertIngredientValues({"chicken"},{meat=0.5,poultry=1},false,false,false)
InsertIngredientValues({"drumstick"},{poultry=1},true,false,true)
InsertIngredientValues({"rabbit"},{meat=0.5},false,false,false)
InsertIngredientValues({"manrabbit_tail"},{inedible=1},false,false,false)
InsertIngredientValues({"froglegs"},{frogmeat=1},true,false,true)
InsertIngredientValues({"toad_meat"},{meat=1,frogmeat=1},true,false,false)
InsertIngredientValues({"squid_meat"},{monster=1,fish=0.5},true,false,false)
InsertIngredientValues({"bear_meat"},{meat=1.5},true,false,false)
InsertIngredientValues({"deer_meat"},{meat=1.5},true,false,false)
InsertIngredientValues({"dragon_meat"},{meat=1},true,false,false)
...
AddPrefabPostInit("beebox", function(inst) 
    if inst.components.harvestable then
        inst:WatchWorldState("isspring", function(inst) inst.components.harvestable.product = "honey_killer" end) -- Seasonal Transitions
        inst:WatchWorldState("issummer", function(inst) inst.components.harvestable.product = "honey_floral" end)
        inst:WatchWorldState("isautumn", function(inst) inst.components.harvestable.product = "honey" end)
        inst:WatchWorldState("iswinter", function(inst) inst.components.harvestable.product = "honey" end)
...
AddPrefabPostInit("beehive", function(inst) 
    if inst.components.lootdropper then
        ...
        inst:WatchWorldState("isspring", function() inst.components.lootdropper:SetLoot({ "honey_killer", "honey_killer", "honey_killer", "honeycomb" }) end) -- Seasonal Transitions
        inst:WatchWorldState("issummer", function() inst.components.lootdropper:SetLoot({ "honey_floral", "honey_floral", "honey_floral", "honeycomb" }) end)
        inst:WatchWorldState("isautumn", function() inst.components.lootdropper:SetLoot({ "honey", "honey", "honey", "honeycomb" }) end)
        inst:WatchWorldState("iswinter", function() inst.components.lootdropper:SetLoot({ "honey", "honey", "honey", "honeycomb" }) end)
    end
end)
...
local function ShouldAcceptMonsterItem(inst, item)
    ...
    local can_accept = (item.components.edible
        ...
        or (item.components.edible.foodtype == GLOBAL.FOODTYPE.MEAT and not item:HasTag("preparedfood"))))
        or item.prefab == "wheat"
...
if GLOBAL.TUNING.FAFHONEYCRYSTALS ~= nil then 
    AllRecipes["spice_sugar"].ingredients = {Ingredient("honey_crystals", 3, "images/inventoryimages/feast_famine.xml", "honey_crystals"),}
...
if MILK then 
    for k, recipe in pairs(require("Milk_foods")) do AddCookerRecipe("portablecookpot", recipe) end
    for k, recipe in pairs(require("Milk_foods")) do AddCookerRecipe("portablespicer", recipe) end

    for k, recipe in pairs(require("Milk_foods_unspicy")) do AddCookerRecipe("portablecookpot", recipe) end

    for k, recipe in pairs(require("Milk_foodspiced")) do AddCookerRecipe("portablespicer", recipe) end
end
...
{
	name = "syrup",
	test = function(cooker, names, tags) return tags.sugar and tags.sugar > 3 end,
...
{
    name = "pasta_wet",
    test = function(cooker, names, tags) return tags.egg and tags.flour end,
...
{
    name = "cheese_goat",
    test = function(cooker, names, tags) return names.goatmilk end,
...
cooking.GetRecipe("cookpot", "jellybean").test = function(cooker, names, tags) return names.royal_jelly and tags.fruit and not tags.inedible and not tags.monster end
cooking.GetRecipe("portablecookpot", "jellybean").test = function(cooker, names, tags) return names.royal_jelly and tags.fruit and not tags.inedible and not tags.monster end
cooking.GetRecipe("cookpot", "icecream").test = function(cooker, names, tags) return tags.frozen and tags.dairy and tags.sweetener and not tags.meat and not tags.veggie and not names.beefalo_milk and not tags.inedible and not tags.egg end -- Beefalo Milk and Cheese Nerf
cooking.GetRecipe("portablecookpot", "icecream").test = function(cooker, names, tags) return tags.frozen and tags.dairy and tags.sweetener and not tags.meat and not tags.veggie and not names.beefalo_milk and not tags.inedible and not tags.egg end -- Beefalo Milk and Cheese Nerf
cooking.GetRecipe("cookpot", "powcake").test = function(cooker, names, tags) return names.twigs and tags.sweetener and (names.corn or names.corn_cooked or names.oceanfish_small_5_inv or names.oceanfish_medium_5_inv) end
cooking.GetRecipe("portablecookpot", "powcake").test = function(cooker, names, tags) return names.twigs and tags.sweetener and (names.corn or names.corn_cooked or names.oceanfish_small_5_inv or names.oceanfish_medium_5_inv) end
...
cooking.GetRecipe("cookpot", "lobsterbisque").test = function(cooker, names, tags) return tags.shellfish and tags.frozen end
cooking.GetRecipe("portablecookpot", "lobsterbisque").test = function(cooker, names, tags) return tags.shellfish and tags.frozen end
cooking.GetRecipe("cookpot", "lobsterdinner").test = function(cooker, names, tags) return tags.shellfish and names.butter and not tags.frozen end
cooking.GetRecipe("portablecookpot", "lobsterdinner").test = function(cooker, names, tags) return tags.shellfish and names.butter and not tags.frozen end

cooking.GetRecipe("cookpot","frogglebunwich").test = function(cooker, names, tags) return tags.frogmeat and tags.veggie end
cooking.GetRecipe("portablecookpot","frogglebunwich").test = function(cooker, names, tags) return tags.frogmeat and tags.veggie end
cooking.GetRecipe("cookpot","turkeydinner").test = function(cooker, names, tags) return tags.poultry and tags.poultry > 1 and tags.meat and tags.meat > 1 and (tags.veggie or tags.fruit) end
cooking.GetRecipe("portablecookpot","turkeydinner").test = function(cooker, names, tags) return tags.poultry and tags.poultry > 1 and tags.meat and tags.meat > 1 and (tags.veggie or tags.fruit) end

cooking.GetRecipe("portablecookpot","frogfishbowl").test = function(cooker, names, tags) return tags.frogmeat and tags.frogmeat >= 2 and tags.fish and tags.fish >= 1 and not tags.inedible end

cooking.GetRecipe("cookpot","honeynuggets").test = function(cooker, names, tags)  return tags.honey and tags.meat and tags.meat <= 1.5 and not tags.inedible end
cooking.GetRecipe("portablecookpot","honeynuggets").test = function(cooker, names, tags)  return tags.honey and tags.meat and tags.meat <= 1.5 and not tags.inedible end
cooking.GetRecipe("cookpot","honeyham").test = function(cooker, names, tags)  return tags.honey and tags.meat and tags.meat > 1.5 and not tags.inedible end
cooking.GetRecipe("portablecookpot","honeyham").test = function(cooker, names, tags)  return tags.honey and tags.meat and tags.meat > 1.5 and not tags.inedible end
cooking.GetRecipe("portablecookpot","freshfruitcrepes").test = function(cooker, names, tags) return tags.fruit and tags.fruit >= 1.5 and names.butter and tags.honey end

cooking.GetRecipe("cookpot","shroomcake").test = function(cooker, names, tags) return names.moon_cap and tags.mushrooms_red and tags.mushrooms_blue and tags.mushrooms_green end
cooking.GetRecipe("portablecookpot","shroomcake").test = function(cooker, names, tags) return names.moon_cap and tags.mushrooms_red and tags.mushrooms_blue and tags.mushrooms_green end

cooking.GetRecipe("cookpot","barnaclepita").test = function(cooker, names, tags) return (names.barnacle or names.barnacle_cooked) and tags.flour end
cooking.GetRecipe("cookpot","barnaclepita").stacksize = 2
cooking.GetRecipe("portablecookpot","barnaclepita").test = function(cooker, names, tags) return (names.barnacle or names.barnacle_cooked) and tags.flour end
cooking.GetRecipe("portablecookpot","barnaclepita").stacksize = 2

cooking.GetRecipe("cookpot","barnaclinguine").test = function(cooker, names, tags) return ((names.barnacle or 0) + (names.barnacle_cooked or 0) >= 2 ) and tags.noodle end
cooking.GetRecipe("cookpot","barnaclinguine").stacksize = 2
cooking.GetRecipe("portablecookpot","barnaclinguine").test = function(cooker, names, tags) return ((names.barnacle or 0) + (names.barnacle_cooked or 0) >= 2 ) and tags.noodle end
cooking.GetRecipe("portablecookpot","barnaclinguine").stacksize = 2

cooking.GetRecipe("cookpot","leafymeatburger").test = function(cooker, names, tags) return (names.plantmeat or names.plantmeat_cooked) and (names.onion or names.onion_cooked) and tags.flour end
cooking.GetRecipe("cookpot","leafymeatburger").stacksize = 2
cooking.GetRecipe("cookpot","leafymeatburger").foodtype = "GOODIES"
cooking.GetRecipe("portablecookpot","leafymeatburger").test = function(cooker, names, tags) return (names.plantmeat or names.plantmeat_cooked) and (names.onion or names.onion_cooked) and tags.flour end
...
cooking.GetRecipe("cookpot","leafloaf").test = function(cooker, names, tags) return tags.plantmeat and tags.plantmeat >= 2 end
cooking.GetRecipe("cookpot","leafloaf").foodtype = "GOODIES"
cooking.GetRecipe("portablecookpot","leafloaf").test = function(cooker, names, tags) return tags.plantmeat and tags.plantmeat >= 2 end
cooking.GetRecipe("portablecookpot","leafloaf").foodtype = "GOODIES"

cooking.GetRecipe("cookpot","leafymeatsouffle").test = function(cooker, names, tags) return names.egg_plant and names.egg_plant >= 2 and tags.sweetener and tags.sweetener >= 2 end
cooking.GetRecipe("cookpot","leafymeatsouffle").foodtype = "GOODIES"
cooking.GetRecipe("portablecookpot","leafymeatsouffle").test = function(cooker, names, tags) return names.egg_plant and names.egg_plant >= 2 and tags.sweetener and tags.sweetener >= 2 end
cooking.GetRecipe("portablecookpot","leafymeatsouffle").foodtype = "GOODIES"

cooking.GetRecipe("cookpot","meatysalad").test = function(cooker, names, tags) return tags.plantmeat and tags.veggie and tags.veggie >= 3 end
cooking.GetRecipe("cookpot","meatysalad").foodtype = "GOODIES"
cooking.GetRecipe("portablecookpot","meatysalad").test = function(cooker, names, tags) return tags.plantmeat and tags.veggie and tags.veggie >= 3 end
cooking.GetRecipe("portablecookpot","meatysalad").foodtype = "GOODIES"

cooking.GetRecipe("cookpot","bunnystew").test = function(cooker, names, tags) return (names.rabbit or names.manrabbit_tail) and (tags.frozen and tags.frozen >= 2) end
cooking.GetRecipe("portablecookpot","bunnystew").test = function(cooker, names, tags) return (names.rabbit or names.manrabbit_tail) and (tags.frozen and tags.frozen >= 2) end

cooking.GetRecipe("cookpot","koalefig_trunk").test = function(cooker, names, tags) return (names.trunk_summer or names.trunk_winter or names.trunk_cooked or names.trunk_winter_cooked) and (names.fig or names.fig_cooked) end
cooking.GetRecipe("portablecookpot","koalefig_trunk").test = function(cooker, names, tags) return (names.trunk_summer or names.trunk_winter or names.trunk_cooked or names.trunk_winter_cooked) and (names.fig or names.fig_cooked) end

if MILK then
    cooking.GetRecipe("cookpot", "cheese").test = function(cooker, names, tags) return tags.dairy and tags.dairy >= 2 end 
    cooking.GetRecipe("portablecookpot", "cheese").test = function(cooker, names, tags) return tags.dairy and tags.dairy >= 2 end 
    cooking.GetRecipe("cookpot", "pizza").test = function(cooker, names, tags) return tags.cheese == 0.5 and tags.meat and tags.veggie end -- edit to allow flour
    cooking.GetRecipe("portablecookpot", "pizza").test = function(cooker, names, tags) return tags.cheese == 0.5 and tags.meat and tags.veggie end
end     

if ISLAND or TROPICAL then 
    cooking.GetRecipe("cookpot", "lobsterdinner").test = function(cooker, names, tags) return tags.shellfish and tags.fat and not tags.frozen end
    cooking.GetRecipe("portablecookpot", "lobsterdinner").test = function(cooker, names, tags) return tags.shellfish and tags.fat and not tags.frozen end
end
...
local flour = AddRecipe2("flour",
    {
        Ingredient("wheat", 3, nil, nil, "quagmire_wheat.tex")
    },
...
local mealingstone = AddRecipe2("mealingstone",
    {
...
local breadbox = AddRecipe2("breadbox",
    {
        Ingredient("boards", 1),
        Ingredient("rope", 1)
    },
...
AddPrefabPostInit("bread_garlic_spice_garlic", function(inst) inst.displaynamefn = garlicdisplaynamefn end)
AddPrefabPostInit("hotchili_spice_chili", function(inst) inst.displaynamefn = chillidisplaynamefn end)