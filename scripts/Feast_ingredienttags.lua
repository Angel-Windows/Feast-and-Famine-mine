...
AddFoodTag('flour', {
    name = 'Flour',
    atlas = "images/feast_food_tags.xml"
})
AddFoodTag('noodle', {
    name = 'Pasta',
    atlas = "images/feast_food_tags.xml"
...
AddFoodTag('mushrooms', {
    name = 'Mushrooms',
    atlas = "images/feast_food_tags.xml"
})
AddFoodTag('mushrooms_blue', {
    name = 'Blue Caps',
    atlas = "images/feast_food_tags.xml"
})
AddFoodTag('mushrooms_green', {
    name = 'Green Caps',
    atlas = "images/feast_food_tags.xml"
})
AddFoodTag('mushrooms_red', {
    name = 'Red Caps',
    atlas = "images/feast_food_tags.xml"
})
AddFoodTag('stone', {
