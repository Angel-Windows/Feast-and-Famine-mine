...
local assets = {Asset("ANIM", "anim/chicken.zip"), Asset("SOUNDPACKAGE", "sound/chickenfamily.fev"),
                Asset("SOUND", "sound/chickenfamily.fsb")}

local prefabs = {"drumstick", "bird_egg", "feather_robin"}
...
local cnames = {"Becky", "Pecky", "Alma", "Annie", "Barbara", "Betty", "Bonnie", "Brandy", "Charlotte", "Clarabelle",
                "Clementine", "Daphne", "Dotty", "Edwina", "Harriet", "Henrietta", "Lacey", "Lucille", "Stella",
                "Octavia", "Millie", "Marabelle", "Josephine", "Muriel", "Loretta", "Isabelle"}
